...
import numpy as np
import torch
from Kpnet.data_augmentation import DataAugmentation
import Kpnet.visualization
...
class PointcloudDataset():
    def __init__(self, inputs_dir, inputs_paths, epsilon=20, device="cpu", mode="train", augmentation=False, num_keypoints=2):
        self.device = device
        ...
        if self.mode == "prediction":
            ...
            if not self.augmentation:
                ...
                if data_augmentation.flip is True:
                    labels_distance = labels_distance[:, :, [1, 0]]
    ...
    def visualize(self, idx):
        ...
        utils_m.visualization.visualize(cloud_cpu, labels_cpu)
